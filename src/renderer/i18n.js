...
const enTranslations = {
    ...
    newProfileBatch: "New / Batch Create",
    ...
    watermarkDesc: "Choose whether to show an environment marker inside webpages. Changes take effect after restarting the profile.",
    watermarkNoneLabel: "No Page Marker (Recommended)",
    watermarkNoneDesc: "Do not inject a visible DOM marker into webpages, reducing site-side detection risk.",
    watermarkEnhancedLabel: "🎯 Enhanced Watermark",
    ...
    importNoValidData: "No valid data found or import cancelled.",
    ok: "OK",
    batchAddSuccess: "Proxy nodes added successfully.",
    ...
    batchEditTitle: "Batch Edit Profiles",
    batchEditDesc: "Only checked fields will be applied to selected profiles.",
    batchEditNoFields: "Select at least one field to update",
    batchEditInvalidScreen: "Resolution must be greater than 0",
    batchEditSuccess: "Batch edit successful",
    batchEditPartialSuccess: "Batch edit completed with failures",
    batchEditFailed: "Batch edit failed",
    batchTagsReplace: "Replace tags",
    batchTagsAppend: "Append tags",
    batchTagsRemove: "Remove tags",
    batchCopy: "Batch Copy",
    batchDelete: "Batch Delete",
    batchDeleteConfirm: "Delete selected profiles?",
    copyProfile: "Copy",
    copyProfileTitle: "Copy Profile",
    copyProfileTarget: "Target",
    copyProfileCount: "Profiles",
    copyNoSelection: "No profiles selected",
    copyModeProfile: "Profile Only",
    copyModeProfileDesc: "Copy profile configuration only, without browser data",
    copyModeFull: "Full Copy",
    copyModeFullDesc: "Copy profile configuration and browser data folder",
    copyConfirm: "Copy",
    copySuccess: "Copy successful",
    copyPartialSuccess: "Copy completed with failures",
