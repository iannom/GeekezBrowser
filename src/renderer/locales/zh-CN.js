...
window.zhCN = {
    ...
    watermarkDesc: "选择是否在网页内显示环境标识，重启环境后生效",
    watermarkNoneLabel: "不注入页面标识（推荐）",
    watermarkNoneDesc: "不向网页 DOM 注入可见标识，降低被站点脚本识别的风险",
    watermarkEnhancedLabel: "🎯 增强水印",
    ...
    saveFailed: "保存失败",
    invalidProxyUrl: "代理链接格式无效",
    importNoValidData: "未发现有效数据，或已取消导入。",
    ok: "确定",
    batchAddSuccess: "代理节点添加成功。",
    batchAddFail: "未发现有效代理节点。",
    // 开发者功能
    ...
    batchLaunch: "批量启动",
    batchEdit: "批量修改",
    batchEditTitle: "批量修改环境",
    batchEditDesc: "仅勾选的字段会应用到已选择的环境。",
    batchEditNoFields: "请至少选择一个要修改的字段",
    batchEditInvalidScreen: "屏幕分辨率必须大于 0",
    batchEditSuccess: "批量修改成功",
    batchEditPartialSuccess: "批量修改完成但有失败项",
    batchEditFailed: "批量修改失败",
    batchTagsReplace: "替换标签",
    batchTagsAppend: "追加标签",
    batchTagsRemove: "移除标签",
    batchCopy: "批量复制",
    batchDelete: "批量删除",
    batchDeleteConfirm: "确定删除已选择的环境？",
    copyProfile: "复制",
    copyProfileTitle: "复制环境",
    copyProfileTarget: "目标环境",
    copyProfileCount: "环境数量",
    copyNoSelection: "请选择要复制的环境",
    copyModeProfile: "仅复制 Profile",
    copyModeProfileDesc: "只复制环境配置，不复制浏览器数据目录",
    copyModeFull: "完整复制",
    copyModeFullDesc: "复制环境配置和浏览器数据目录",
    copyConfirm: "复制",
    copySuccess: "复制成功",
    copyPartialSuccess: "复制完成但有失败项",
    copyFailed: "复制失败",
